      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8 md:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-neutral-900 tracking-tight">
            المنتجات الأكثر مبيعًــا
          </h2>

          <div className="flex items-center gap-2" dir="ltr">
            <button
              onClick={() => swiperInstance?.slidePrev()}
              className="w-10 h-10 md:w-11 md:h-11 rounded-xl sm:rounded-2xl bg-neutral-100 flex items-center justify-center text-neutral-800 hover:bg-neutral-900 hover:text-white hover:border-neutral-900 active:scale-95 transition-all duration-300 cursor-pointer"
            >
