    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col font-sans" dir="rtl">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="bg-white rounded-3xl border border-neutral-100 shadow-sm p-8 md:p-12 text-center space-y-8 animate-fade-in-up">
          <div className="w-20 h-20 bg-neutral-100 text-neutral-900 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="bg-neutral-50 p-6 rounded-2xl text-right space-y-6 max-w-xl mx-auto border border-neutral-100">
            ...
            <ul className="space-y-4 text-neutral-600">
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-neutral-900 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">1</span>
                <span>قم بتعبئة نموذج الطلب أدناه أو تواصل معنا عبر الواتساب لتحديد موعد الاستلام.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-neutral-900 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">2</span>
                <span>سيصلك مندوبنا لاستلام الهدية بكل أمان.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-neutral-900 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">3</span>
                <span>سنقوم بتغليفها وتنسيقها حسب اختيارك (ورود، بطاقات، أشرطة).</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-neutral-900 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">4</span>
          ...
          <div className="pt-8">
            <a 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-neutral-900 text-white font-bold rounded-full shadow-md hover:bg-neutral-800 transition-all duration-200"
            >
